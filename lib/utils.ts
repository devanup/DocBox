...
// takes the inputs and merges them with tailwind-merge
export function cn(...inputs: ClassValue[]) {
	return twMerge(clsx(inputs));
}

// takes the data and returns a deep copy of the data
...
// takes the extension and type and returns the file icon
